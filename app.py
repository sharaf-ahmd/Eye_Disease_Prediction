...
def load_model():
    ...
    "Eye_disease_prediction_model.h5",
...
#About Project
    ...
    if(st.button("Predict")) and test_image is not None:
        ...
        with st.expander("Learn More"):
            ...
            if(result_index==0):
                st.write('''
                    OCT scan shows *CNV with subretinal fluid.*
                ''')
                st.image(test_image)
            ...
            #DME
                ...
                st.write('''
                    OCT scan shows *DME with retinal thickening and intraretinal fluid.*
                ''')
                st.image(test_image)
            ...
            #DRUSEN
                ...
                st.write('''
                    OCT scan shows *drusen deposits in early AMD.*
                ''')
                st.image(test_image)
            ...
            #NORMAL
                ...
                st.write('''
                    OCT scan shows a *normal retina with preserved foveal contour.*
                ''')
                st.image(test_image)
